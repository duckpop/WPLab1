    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers("/", "/dishes", "/chefs", "/dish", "/dishes/listChefs", "/chefDetails", "/login", "/register", "/css/**", "/js/**").permitAll()
                        .requestMatchers("/dishes/dish-form",
                                         "/dishes/dish-form/**",
                                         "/dishes/delete/**",
                                         "/dishes/edit/**",
                                         "/chefs/chef-form",
