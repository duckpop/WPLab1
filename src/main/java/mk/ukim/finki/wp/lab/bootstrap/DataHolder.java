    ...
    public void init() {
        ...
        if (chefRepository.count() == 0) {
            ...
            if (dishRepository.count() == 0) {
                ...
                Dish d2 = new Dish("d2", "Chicken Teriyaki", "Japanese", 25);
                d2.setChef(c2);

                Dish d3 = new Dish("d3", "Tacos Al Pastor", "Mexican", 15);
                d3.setChef(c3);

                Dish d4 = new Dish("d4", "Pad Thai", "Thai", 18);
                d4.setChef(c4);

                Dish d5 = new Dish("d5", "Greek Salad", "Greek", 10);
                d5.setChef(c5);
